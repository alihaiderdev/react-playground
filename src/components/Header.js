      ...
      <div className='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center'>
        ...
        {Object.keys(user || {})?.length > 0 ? (
          ...
          <>
            ...
            <Link
              to={`/auth/login`}
              className='lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded hover:text-white mx-4'
            >
              Login
            </Link>
          </>
